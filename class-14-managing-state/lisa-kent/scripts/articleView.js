(function(module) {
  ...
  /*populates the defined filters by authors and categories using the templates*/
  ...
  /*handles when filter changes on drop down menu by setting the page route by contructing the URL*/
  ...
  //intializes "new article" HTML page
  ...
  //creates "new article" preview on page
  ...
  // replaces the article section contents with the given articles
